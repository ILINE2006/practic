...
<form method="post" enctype="multipart/form-data">
        ...
        <div class="form-grid">
            <div class="form-group"><label>Фамилия</label><input type="text" name="last_name" class="form-control" required></div>
            <div class="form-group"><label>Имя</label><input type="text" name="first_name" class="form-control" required></div>
            <div class="form-group"><label>Отчество</label><input type="text" name="middle_name" class="form-control"></div>

            <div class="form-group"><label>Дата рождения</label><input type="date" name="birth_date" class="form-control" required></div>
            ...
            <div class="form-group"><label>Фото (Аватар)</label><input type="file" name="avatar" class="form-control" accept="image/*"></div>
            ...
            <div class="form-group" style="grid-column: span 2;">
                <label>Название должности (впишите текстом)</label>
                <input type="text" name="position_title" class="form-control" placeholder="Например: Старший бухгалтер" required>
            </div>
            <div class="form-group">
                <label>Состав (Категория)</label>
                <select name="position_category" class="form-control">
            ...
            <div class="form-group">
                ...
                <input type="text" name="address_region" class="form-control" placeholder="Московская обл." required>
            </div>
            <div class="form-group">
                <label>Город / Населенный пункт</label>
                <input type="text" name="address_city" class="form-control" placeholder="г. Москва" required>
            </div>
            <div class="form-group">
                <label>Улица</label>
                <input type="text" name="address_street" class="form-control" placeholder="ул. Ленина" required>
            </div>
            <div class="form-group">
                <label>Дом / Строение</label>
                <input type="text" name="address_house" class="form-control" placeholder="д. 15, корп. 2" required>
            </div>
        </div>
